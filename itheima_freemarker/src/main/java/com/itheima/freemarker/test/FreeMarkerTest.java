...
public class FreeMarkerTest {
    ...
    public void test() throws Exception {
        ...
        //2、用核心对象指定模板的地址
        configuration.setDirectoryForTemplateLoading(new File("D:\\java_87\\workspaces\\itheima_freemarker\\src\\main\\resources"));
        //3、设置模板的编码集
        ...
        FileWriter fileWriter = new FileWriter(new File("D:\\java_87\\item\\123.html"));
        //7、用模板对象中的process方法来输出
        //参数说明：2、指定输出的文件路径流；1、指定输出的数据
